...
abstract contract Governor {
    ...
    returns (ProposalState)
  {
    ...
    uint256 quorumVotes = (_getTotalVotes() * proposal.ballotQuorumThreshold) /
      10000; // /10000 because 10000 = 100%
  ...
  function _castVote(
    ...
    require(proposals[proposalId].endBlock > block.number, "Voting finished");
